...
##    --mail-user=${MYEMAIL} \
##    -J bam-bed-${<INPUTFILE>##*/} \
##    bam-bed.sh <OUTPUT LOCATION> <INPUT BAM FILE>

############################################################################
##SCRIPT NAME:

SCRIPTNAME=$(echo "bam-bed.sh") 
...
OUTPUTFILENAME=$(echo "${INPUTFILEPREFIX}.bamtobed-job${JOBID}.bed")
...
##Convert BAM file to BED file.
bedtools bamtobed -i ${INPUTFILE} > ${OUTPUTFILE}
