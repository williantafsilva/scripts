...
##    --mail-type=ALL \
##    --mail-user=${MYEMAIL} \
##    -J vcf-summarytable-${<INPUTFILE>##*/} \
##    vcf-summarytable.sh <OUTPUT LOCATION> <INPUT VCF FILE> 

############################################################################
##SCRIPT NAME:

SCRIPTNAME=$(echo "vcf-summarytable.sh") 
...
OUTPUTFILENAME=$(echo "${OUTPUTFILEPREFIX}.summary-job${JOBID}.txt") 
