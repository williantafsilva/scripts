...
##Required environment variables: ${PATHTOMYTMPSCRIPTS}, ${PATHTOMYSUBMITTEDSCRIPTS}, ${PATHTOMYSLURM}, ${PATHTOPROJTMP}, ${PROJECT_ID}, ${MYSLURMFILE}, ${MYEMAIL}.
############################################################################
################################## SCRIPT ##################################
############################################################################
...
##Description:
##Run R script (.R) located in scripts-tmp directory.
...
##    --mail-type=ALL \
##    --mail-user=${MYEMAIL} \
##    -J Rscript-tmpscript-${<INPUTFILE>##*/} \
##    Rscript-tmpscript.sh <R SCRIPT FILE NAME> <OUTPUT LOCATION> <INPUT ARGUMENTS>

############################################################################
##SCRIPT NAME:

SCRIPTNAME=$(echo "Rscript-tmpscript.sh") 
