...
##Description:
##Pre-process paired-end FastQ files using Fastp (no deduplication applied).
...
##    --mail-type=ALL \
##    --mail-user=${MYEMAIL} \
##    -J fastqPE-fastp-nodedup-${<INPUTFILE>##*/} \
##    fastqPE-fastp-nodedup.sh <OUTPUT LOCATION> <INPUT READ 1 FASTQ FILE> <INPUT READ 2 FASTQ FILE>

############################################################################
##SCRIPT NAME:

SCRIPTNAME=$(echo "fastqPE-fastp-nodedup.sh") 
