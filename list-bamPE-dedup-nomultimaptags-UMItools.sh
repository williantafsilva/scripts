...
##    --mail-type=ALL \
##    --mail-user=${MYEMAIL} \
##    -J list-bamPE-dedup-nomultimaptags-UMItools-${<INPUTFILE>##*/} \
##    list-bamPE-dedup-nomultimaptags-UMItools.sh <OUTPUT LOCATION> <INPUT LIST FILE> 

############################################################################
##SCRIPT NAME:

SCRIPTNAME=$(echo "list-bamPE-dedup-nomultimaptags-UMItools.sh") 
