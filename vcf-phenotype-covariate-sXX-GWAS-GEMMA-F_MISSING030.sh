...
##    vcf-phenotype-covariate-sXX-GWAS-GEMMA.sh <OUTPUT LOCATION> <INPUT VCF FILE> <INPUT PHENOTYPE FILE> <INPUT COVARIATE FILE> <INPUT RELATEDNESS FILE> <LIST OF PHENOTYPE INDICES>

############################################################################
##SCRIPT NAME:

SCRIPTNAME=$(echo "vcf-phenotype-covariate-sXX-GWAS-GEMMA.sh") 
...
plink --vcf ${INPUTVCFFILE} --maf 0.05 --geno 0.3 --allow-extra-chr --chr-set 39 --make-bed --out ${TMPFILEPREFIX}
