...
##    vcf-phenotype-covariate-sXX-GWAS-GEMMA-miss030.sh <OUTPUT LOCATION> <INPUT VCF FILE> <INPUT PHENOTYPE FILE> <INPUT COVARIATE FILE> <INPUT RELATEDNESS FILE> <LIST OF PHENOTYPE INDICES>

############################################################################
##SCRIPT NAME:

SCRIPTNAME=$(echo "vcf-phenotype-covariate-sXX-GWAS-GEMMA-miss030.sh") 
