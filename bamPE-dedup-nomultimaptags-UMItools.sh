...
##    --mail-type=ALL \
##    --mail-user=${MYEMAIL} \
##    -J bamPE-dedup-nomultimaptags-UMItools-${<INPUTFILE>##*/} \
##    bamPE-dedup-nomultimaptags-UMItools.sh <OUTPUT LOCATION> <INPUT BAM FILE> 

############################################################################
##SCRIPT NAME:

SCRIPTNAME=$(echo "bamPE-dedup-nomultimaptags-UMItools.sh") 
