...
##    --mail-type=ALL \
##    --mail-user=${MYEMAIL} \
##    -J vcf-biallelic-${<INPUTFILE>##*/} \
##    vcf-biallelic.sh <OUTPUT LOCATION> <INPUT VCF FILE> 


############################################################################
##SCRIPT NAME:

SCRIPTNAME=$(echo "vcf-biallelic.sh") 
...
bcftools view --min-alleles 2 --max-alleles 2 --types snps --write-index=tbi --output-type z --output ${OUTPUTFILE1} ${INPUTFILE}
