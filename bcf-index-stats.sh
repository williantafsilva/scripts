...
##Output: Index file (.csi) and stats file (.txt).
...
##    --mail-type=ALL \
##    --mail-user=${MYEMAIL} \
##    -J bcf-index-stats-${<INPUTFILE>##*/} \
##    bcf-index-stats.sh <OUTPUT LOCATION> <INPUT BCF FILE> 

############################################################################
##SCRIPT NAME:

SCRIPTNAME=$(echo "bcf-index-stats.sh") 
...
OUTPUTFILE1NAME=$(echo "${INPUTFILENAME}.csi") 
